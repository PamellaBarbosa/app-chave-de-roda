...
export default function AtdCaminhao({ navigation }) {
  ...
  function addAtd(){
    ...
    db.collection('Atendimento Caminhão').add({
      id: id,
      nomeServico: servico,
      tipoServico: "Caminhao",
      valorServico: price,
      prazo: prazo,
      horaAgendada: Date()
  ...
  return (
    ...
    <View>
      ...
      <Text style = {estilo.titulo}>Caminhão</Text>
      ...
      <div style = {estilo.checkItens}>
        <div >
          <div >
            ...
            <div style = {estilo.spanPrecos}> R$ 110.00</div>
          ...
          <div>
            ...
            <div style = {estilo.spanPrecos}> R$ 100.00</div>
            <div style = {estilo.check}> 
          ...
          <div>
            ...
            <div style = {estilo.spanPrecos}> R$ 200.00</div>
            <div style = {estilo.check}> 
